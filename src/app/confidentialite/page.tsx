      ...
      <Container>
        <div className="space-y-6 text-ink/80">
          ...
          <p className="text-base leading-relaxed">
            ...
            les utilisateurs du site sharonmaman-avocat.fr des modalités de
            collecte, d’utilisation et de protection de leurs données personnelles,
          ...
          <p className="text-sm text-ink/70">
            Les informations communiquées via le formulaire peuvent contenir des
            données sensibles (notamment relatives à des procédures judiciaires).
            Il est recommandé de ne transmettre que les informations strictement
            nécessaires à la prise de contact.
          </p>
          ...
          <ul className="list-disc space-y-1 pl-5 text-sm">
            ...
            <li>
              Respecter les obligations légales et déontologiques de la profession
              d’avocat
            </li>
          ...
          <ul className="list-disc space-y-1 pl-5 text-sm">
            <li>Le consentement de l’utilisateur (formulaire de contact)</li>
          ...
          <p className="text-sm">
            Certains outils utilisés (ex : hébergement, messagerie) peuvent
            impliquer un transfert de données hors de l’Union européenne.
          </p>
          <p className="text-sm">
            Dans ce cas, des garanties appropriées sont mises en place conformément
            au RGPD (clauses contractuelles types ou mécanismes reconnus par la
          ...
          <p className="text-sm">
            ...
            appropriées afin d’assurer la sécurité et la confidentialité des données
          ...
          <p className="text-sm">En cas de litige, vous pouvez saisir la CNIL : www.cnil.fr</p>
          ...
          <p className="text-sm">
            ...
            ainsi que, le cas échéant, des cookies de mesure d’audience ou tiers.
          </p>
          <p className="text-sm">
            À ce jour, aucun bandeau de gestion des cookies n’est proposé car le
            site n’utilise pas d’outils de mesure d’audience ou de cookies publicitaires.
          </p>
          <p className="text-sm">
